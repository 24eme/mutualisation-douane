...
$ping = file_get_contents("http://10.124.111.12/authtoken/oauth2/v1/ping", false, stream_context_create(array('http' => array('timeout' => 2))));

if($ping && preg_match('/Europe.Paris/', $ping) ): ?>

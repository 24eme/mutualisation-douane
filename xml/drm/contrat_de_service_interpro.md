...
IIP1RG29 | Dans un même compte CRD, une centilisation ne peut apparaître qu’une seule fois (unicité de l’attribut « volume » de la centilisation pour une catégorie fiscale | donnée et un type de capsules donné)  | 021  | La cntilisation <volume> pour la catégorie <catégorie> (<type de capsule>) devrait être unique dans un même compte CRD. |
